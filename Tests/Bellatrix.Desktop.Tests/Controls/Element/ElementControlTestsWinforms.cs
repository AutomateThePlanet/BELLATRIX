...
namespace Bellatrix.Desktop.Tests
{
    ...
    public class ElementControlTestsWinForms : BellatrixBaseTest
    {
        ...
        {
            var button = App.ElementCreateService.CreateByAutomationId<Button>("btnShowAfter");
        ...
        {
            var label = App.ElementCreateService.CreateByAccessibilityId<Button>("labelScrolledTo");
        ...
        {
            var comboBox = App.ElementCreateService.CreateByAccessibilityId<Button>("clBox");
