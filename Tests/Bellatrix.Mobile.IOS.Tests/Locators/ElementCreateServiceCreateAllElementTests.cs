...
namespace Bellatrix.Mobile.IOS.Tests
{
    ...
    public class ElementCreateServiceCreateAllElementTests : MSTest.IOSTest
    {
        ...
        {
            var textFields = App.ElementCreateService.CreateAllById<TextField>("IntegerA");
        ...
        {
            var textFields = App.ElementCreateService.CreateAllByClass<CheckBox>("XCUIElementTypeTextField");
        ...
        {
            var labels = App.ElementCreateService.CreateAllByValueContaining<Label>("SumLabel");
        ...
        {
            var buttons = App.ElementCreateService.CreateAllByIOSNsPredicate<Button>("type == \"XCUIElementTypeButton\" AND name == \"ComputeSumButton\"");
        ...
        {
            var buttons = App.ElementCreateService.CreateAllByXPath<Button>("//XCUIElementTypeButton[@name=\"ComputeSumButton\"]");
