...
namespace Bellatrix.Mobile.IOS.Tests
{
    ...
    public class TabsControlTests : IOSTest
    {
        [TestMethod]
        [Timeout(180000)]
        public void GetAllTabs_When_CallGetAllWithButtonControl()
        {
            var tabs = App.ElementCreateService.CreateByIOSNsPredicate<Tabs<TextField>>("type == \"XCUIElementTypeApplication\" AND name == \"TestApp\"");
            ...
            var resultLabel = App.ElementCreateService.CreateByName<Label>("Answer");
