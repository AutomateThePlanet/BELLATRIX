// <copyright file="TimeControlTestsOpera.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.Web.Tests.Controls
{
    ...
    public class TimeControlTestsOpera : MSTest.WebTest
    {
        public override void TestInit() => App.NavigationService.NavigateToLocalPage(SettingsService.GetSection<TestPagesSettings>().TimeLocalPage);

        [TestMethod]
        [TestCategory(Categories.Opera)]
        public void DecimalTimeSet_When_UseSetTimeMethod_Opera()
        {
        ...
        [TestMethod]
        [TestCategory(Categories.Opera)]
        public void IntegerTimeSet_When_UseSetTimeMethod_Opera()
        {
            var timeElement = App.ElementCreateService.CreateById<Time>("myTime");
        ...
        [TestMethod]
        [TestCategory(Categories.Opera)]
        public void GetTimeReturnsCorrectTime_When_DefaultTimeIsSet_Opera()
        {
