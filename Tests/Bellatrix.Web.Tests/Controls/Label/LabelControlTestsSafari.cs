// <copyright file="LabelControlTestsSafari.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.Web.Tests.Controls
{
    ...
    public class LabelControlTestsSafari : WebTest
    {
        ...
        [TestMethod]
        [Ignore, TestCategory(Categories.Safari), TestCategory(Categories.OSX)]
        public void ReturnHover_When_InnerTextSet_Safari()
        {
            var labelElement = App.ElementCreateService.CreateById<Label>("myLabel");
        ...
        [TestMethod]
        [Ignore, TestCategory(Categories.Safari), TestCategory(Categories.OSX)]
        public void ReturnLabelFor_When_ForSet_Safari()
        {
            var labelElement = App.ElementCreateService.CreateById<Label>("myLabel");
