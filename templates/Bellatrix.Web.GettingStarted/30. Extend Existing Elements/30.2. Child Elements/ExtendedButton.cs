...
{
    // 1. The second way of extending an existing element is to create a child ElementCreateService.
    // Inherit the element you want to extend. In this case, two methods are added to the standard Button ElementCreateService.
