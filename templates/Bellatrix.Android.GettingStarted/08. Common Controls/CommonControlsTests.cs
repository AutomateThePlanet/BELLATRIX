...
namespace Bellatrix.Mobile.Android.GettingStarted
{
    ...
    public class CommonControlsTests : MSTest.AndroidTest
    {
        ...
        public void CommonActionsWithAndroidControls()
        {
            ...
            App.ComponentCreateService.CreateByClass<SeekBar>("android.widget.SeekBar");
            ...
            var password = App.ComponentCreateService.CreateByDescription<Password>("passwordBox");
