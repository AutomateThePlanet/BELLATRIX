...
namespace Bellatrix.Mobile.IOS.GettingStarted
{
    ...
    public class LocateElementsTests : MSTest.IOSTest
    {
        ...
        public void ElementFound_When_CreateById_And_ElementIsOnScreen()
        {
            ...
            var button = App.ComponentCreateService.CreateById<Button>("ComputeSumButton");
        ...
        {
            var alertButton = App.ComponentCreateService.CreateByName<Button>("Sunday, November 11");
            ...
            var answerLabel = App.ComponentCreateService.CreateById<Button>("Bellatrix, from 11:00 PM to Monday, November 12, 12:00 AM");
            answerLabel.ScrollToVisible(ScrollDirection.Up);

            answerLabel.Click();

            var testLabel = App.ComponentCreateService.CreateById<Label>("Bellatrix");
            ...
            //
            // CreateByName  --> App.ComponentCreateService.CreateByName<Button>("ComputeSumButton");
            // Searches the element by its name.
            //
            // CreateByValueContaining  --> App.ComponentCreateService.CreateByValueContaining<Label>("SumLabel");
            // Searches the element by its value if it contains specified value.
            //
            // CreateByIOSUIAutomation  --> App.ComponentCreateService.CreateByIOSUIAutomation<TextField>(".textFields().withPredicate("value == 'Search eBay'")");
            // Searches the element by iOS UIAutomation expressions.
            //
            // CreateByIOSNsPredicate  --> App.ComponentCreateService.CreateByIOSNsPredicate<RadioButton>("type == \"XCUIElementTypeSwitch\" AND name == \"All-day\"");
            // Searches the element by iOS NsPredicate expression.
            //
            // CreateByClass  --> App.ComponentCreateService.CreateByClass<TextField>("XCUIElementTypeTextField");
            // Searches the element by its class.
            //
            // CreateByXPath  --> App.ComponentCreateService.CreateByXPath<Button>("//XCUIElementTypeButton[@name=\"ComputeSumButton\"]");
        ...
        public void ElementFound_When_CreateAllById_And_ElementIsOnScreen()
        {
            ...
            var buttons = App.ComponentCreateService.CreateAllById<Button>("ComputeSumButton");
            ...
            //
            // CreateAllByName  --> App.ComponentCreateService.CreateAllByName<Button>("ComputeSumButton");
            // Searches the elements by their name.
            //
            // CreateByValueContaining  their App.ComponentCreateService.CreateAllByValueContaining<Label>("SumLabel");
            // Searches the element by its value if it contains specified value.
            //
            // CreateAllByIOSUIAutomation  --> App.ComponentCreateService.CreateAllByIOSUIAutomation<TextField>(".textFields().withPredicate("value == 'Search eBay'")");
            // Searches the elements by iOS UIAutomation expressions.
            //
            // CreateAllByIOSNsPredicate  --> App.ComponentCreateService.CreateAllByIOSNsPredicate<RadioButton>("type == \"XCUIElementTypeSwitch\" AND name == \"All-day\"");
            // Searches the elements by iOS NsPredicate expression.
            //
            // CreateAllByClass  --> App.ComponentCreateService.CreateAllByClass<TextField>("XCUIElementTypeTextField");
            // Searches the elements by their class.
            //
            // CreateAllByXPath  --> App.ComponentCreateService.CreateAllByXPath<Button>("//XCUIElementTypeButton[@name=\"ComputeSumButton\"]");
