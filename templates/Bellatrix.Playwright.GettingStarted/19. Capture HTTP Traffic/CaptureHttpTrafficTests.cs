...
// 1. Bellatrix offers an interface to the HTTP functionalities of Playwright.
// As Playwright doesn't by default capture and store traffic, Bellatrix does it for you.
// To turn on the capturing you need open the testFrameworkSettings.json file and set the shouldCaptureHttpTraffic to true.
// "webSettings": {
