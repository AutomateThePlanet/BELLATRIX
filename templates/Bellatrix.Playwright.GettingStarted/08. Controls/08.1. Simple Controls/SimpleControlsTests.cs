...
public class SimpleControlsTests : NUnit.WebTest
{
    ...
    // For example, you cannot type into a button. Moreover, this way all of the actions has meaningful names- Type not FillAsync as in vanilla Playwright.
    [Test]
    ...
    public void PurchaseRocket()
    {
        ...
        // 6. Locate elements by custom attribute. Also, bellow BELLATRIX waits until the anchor is clickable before doing any actions.
        ...
        // 9. Instead of using vanilla Playwright FillAsync to set the text, use the SetText method.
        ...
        // the text or event may not happen immediately.
    ...
    //
    // Anchor- Click, Hover, Focus, Href, InnerText, InnerHtml, Target, Rel
    // Button- Click, Hover, Focus, InnerText, Value, IsDisabled
