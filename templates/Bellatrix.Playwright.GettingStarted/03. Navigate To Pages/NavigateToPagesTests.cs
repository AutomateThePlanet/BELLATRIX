...
public class NavigateToPagesTests : NUnit.WebTest
{
    ...
    public void PromotionsPageOpened_When_PromotionsButtonClicked()
    {
        ...
        // 4. Sometimes, we have to explicitly wait for the page to load.
        // Keep in mind that usually this is not necessary since BELLATRIX and Playwright have complex built-in mechanisms for handling element waits.
        ...
        App.Browser.WaitForLoadState();

        // Another Wait we could use is wait for AJAX to complete, but this will be slower than the WaitForLoadState() because it sends JS
    ...
    public void GetUrlsBasedOnTestEnvironment()
    {
        ...
        // To be able to, you need to create a simple C# class holding the URL names as public string properties. Similar to UrlSettings class.
        // Here, we pass to the GetUrl method UrlSettings which tells the method how to find and deserialize (convert to object) that particular section of the JSON file.
