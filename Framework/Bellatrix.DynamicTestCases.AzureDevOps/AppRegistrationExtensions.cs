...
namespace Bellatrix
{
    ...
    {
        public static BaseApp UseAzureDevOpsDynamicTestCases(this BaseApp baseApp)
        {
            baseApp.RegisterInstance(new DynamicTestCasesService());
            baseApp.RegisterType<ITestCaseManagementService, AzureDevOpsTestCaseManagementService>();
