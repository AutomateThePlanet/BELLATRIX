...
namespace Bellatrix
{
    public static class ConfigurationServiceExtensions
    {
        ...
        {
            var result = ConfigurationService.Instance.Root.GetSection("loadTestingSettings").Get<LoadTestingSettings>();

            if (result == null)
            {
                throw new ConfigurationNotFoundException(typeof(LoadTestingSettings).ToString());
            }
