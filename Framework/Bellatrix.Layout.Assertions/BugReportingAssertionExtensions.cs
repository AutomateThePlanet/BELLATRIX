// <copyright file="BugReportingAssertionExtensions.cs" company="Automate The Planet Ltd.">
...
{
    public class BugReportingAssertionExtensions : AssertionsExtensionsEventHandlers
    {
        ...
        protected override void AssertedAboveOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is above of {arg.SecondElement.ElementName}.");

        protected override void AssertedAboveOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px above of {arg.SecondElement.ElementName}.");

        protected override void AssertedAboveOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px above of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedAboveOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px above of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");
        ...
        protected override void AssertedBelowOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px below of {arg.SecondElement.ElementName}.");

        protected override void AssertedBelowOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px below of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedBottomInsideOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is bottom inside of {arg.SecondElement.ElementName}.");

        protected override void AssertedBottomInsideOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px bottom inside of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedBottomInsideOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px bottom inside of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");

        protected override void AssertedHeightEventHandler(object sender, LayoutElementActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} height ", $"is {arg.ActionValue} px.");

        protected override void AssertedHeightBetweenEventHandler(object sender, LayoutElementTwoValuesActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} height ", $"is {arg.ActionValue}-{arg.SecondActionValue} px.");
        ...
        protected override void AssertedHeightApproximateSecondElementEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} height ", $"is ~{arg.ActionValue}% of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedLeftInsideOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is left inside of {arg.SecondElement.ElementName}.");

        protected override void AssertedLeftInsideOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px left inside of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedLeftInsideOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px left inside of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedLeftInsideOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px left inside of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");
        ...
        protected override void AssertedLeftOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is left of {arg.SecondElement.ElementName}.");

        protected override void AssertedLeftOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px left of {arg.SecondElement.ElementName}.");

        protected override void AssertedLeftOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px left of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedLeftOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px left of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");
        ...
        protected override void AssertedNearBottomOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is near bottom of {arg.SecondElement.ElementName}.");

        protected override void AssertedNearBottomOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px near bottom of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedNearBottomOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px near bottom of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedNearBottomOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px near bottom of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");
        ...
        protected override void AssertedNearLeftOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is near left of {arg.SecondElement.ElementName}.");

        protected override void AssertedNearLeftOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px near left of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedNearLeftOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px near left of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedNearLeftOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px near left of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");
        ...
        protected override void AssertedNearRightOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is near right of {arg.SecondElement.ElementName}.");

        protected override void AssertedNearRightOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px near right of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedNearRightOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px near right of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedNearRightOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px near right of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");
        ...
        protected override void AssertedNearTopOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is near top of {arg.SecondElement.ElementName}.");

        protected override void AssertedNearTopOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px near top of {arg.SecondElement.ElementName}.");

        protected override void AssertedNearTopOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px near top of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedNearTopOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px near top of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");
        ...
        protected override void AssertedRightInsideOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is right inside of {arg.SecondElement.ElementName}.");

        protected override void AssertedRightInsideOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px right inside of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedRightInsideOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px right inside of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedRightInsideOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px right inside of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");
        ...
        protected override void AssertedRightOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is right of {arg.SecondElement.ElementName}.");

        protected override void AssertedRightOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px right of {arg.SecondElement.ElementName}.");

        protected override void AssertedRightOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px right of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedRightOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px right of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");
        ...
        protected override void AssertedTopInsideOfNoExpectedValueEventHandler(object sender, LayoutTwoElementsNoExpectedActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is top inside of {arg.SecondElement.ElementName}.");

        protected override void AssertedTopInsideOfEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px top inside of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedTopInsideOfBetweenEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px top inside of {arg.SecondElement.ElementName}.");
        ...
        protected override void AssertedTopInsideOfApproximateEventHandler(object sender, LayoutTwoElementsActionTwoValuesEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} ", $"is {arg.ActionValue} px top inside of {arg.SecondElement.ElementName}. ({arg.SecondActionValue}% tolerance)");

        protected override void AssertedWidthEventHandler(object sender, LayoutElementActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} width ", $"is {arg.ActionValue} px.");
        ...
        protected override void AssertedWidthApproximateSecondElementEventHandler(object sender, LayoutTwoElementsActionEventArgs arg)
            => BugReportingContextService.AddAssertStep($"Assert {arg.Element.ElementName} width ", $"is ~{arg.ActionValue}% of {arg.SecondElement.ElementName}.");
    }
}