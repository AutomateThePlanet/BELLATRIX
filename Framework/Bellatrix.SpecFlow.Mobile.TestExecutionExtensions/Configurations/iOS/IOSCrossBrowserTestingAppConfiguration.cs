...
{
    public class IOSCrossBrowserTestingAppConfiguration : CrossBrowserTestingAppConfiguration
    {
        public IOSCrossBrowserTestingAppConfiguration()
        {
            MobileOSType = MobileOSType.IOS;
            PlatformName = "iOS";
        }
