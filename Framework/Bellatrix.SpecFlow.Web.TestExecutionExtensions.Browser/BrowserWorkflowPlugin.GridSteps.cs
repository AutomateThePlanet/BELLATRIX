...
namespace Bellatrix.SpecFlow.Web.TestExecutionExtensions.Browser
{
    ...
    {
        [Given(@"I open (.*) browser in Grid")]
        public void GivenOpenBrowserInGrid(string browser)
        {
            ...
            _currentBrowserConfiguration = _gridBrowserConfiguration;
        }

        [Given(@"I open (.*) browser (.*) in Grid")]
        public void GivenOpenBrowserInGrid(string browser, string browserVersion)
        {
            _gridBrowserConfiguration = new GridBrowserConfiguration
            {
                BrowserType = (BrowserType)Enum.Parse(typeof(BrowserType), browser),
        ...
        [Given(@"I want to run the browser on (.*) platform in Gird")]
        public void GivenRunBrowserOnPlatformInGrid(string platform)
        {
            _gridBrowserConfiguration.Platform = platform;
        }
    }
}