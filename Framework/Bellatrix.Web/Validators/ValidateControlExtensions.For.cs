...
namespace Bellatrix.Web
{
    public static partial class ValidateControlExtensions
    {
            ...
            where T : IElementFor, IElement
        {
            ...
            ValidatedForIsNullEvent?.Invoke(control, new ElementActionEventArgs(control));
        }
            ...
            where T : IElementFor, IElement
        {
            ...
            ValidatedForIsEvent?.Invoke(control, new ElementActionEventArgs(control, value));
        }

        public static event EventHandler<ElementActionEventArgs> ValidatedForIsNullEvent;
        public static event EventHandler<ElementActionEventArgs> ValidatedForIsEvent;
    }
}