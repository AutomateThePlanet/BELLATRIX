...
namespace Bellatrix.Web
{
    public class Select : Element, IElementDisabled, IElementRequired, IElementReadonly
    {
        ...
        public static Action<Select, string> OverrideSelectByTextGlobally;
        ...
        public static Action<Select, string> OverrideSelectByTextLocally;
        ...
        public static new void ClearLocalOverrides()
        {
            ...
            OverrideSelectByIndexLocally = null;
        ...
        {
            var action = InitializeAction(this, OverrideGetSelectedValueGlobally, OverrideGetSelectedValueLocally, DefaultSelectedValue);
            return action();
        }

        public List<Option> GetAllOptions()
        {
            var action = InitializeAction(this, OverrideGetAllOptionsGlobally, OverrideGetAllOptionsLocally, DefaultGetAllOptions);
            return action();
        }
        ...
        {
            var action = InitializeAction(this, OverrideSelectByIndexGlobally, OverrideSelectByIndexLocally, DefaultSelectByIndex);
            action(index);
        }
        ...
        protected virtual bool DefaultGetRequired(Select select) => base.DefaultGetRequired(select);
    }
