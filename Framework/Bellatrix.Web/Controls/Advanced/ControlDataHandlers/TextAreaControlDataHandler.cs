// <copyright file="TextAreaControlDataHandler.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.Web.Controls.Advanced.ControlDataHandlers
{
    public class TextAreaControlDataHandler : IEditableControlDataHandler<TextArea>
    {
        ...
        public void EnsureValueIs(TextArea element, string expectedValue) => element.EnsureTextIs(expectedValue);
    }
}