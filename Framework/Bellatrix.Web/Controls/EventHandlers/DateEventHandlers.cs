// <copyright file="DateEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class DateEventHandlers : ElementEventHandlers
    {
        public override void SubscribeToAll()
        {
            base.SubscribeToAll();
            Date.Hovering += HoveringEventHandler;
            Date.Hovered += HoveredEventHandler;
            Date.Focusing += FocusingEventHandler;
            Date.Focused += FocusedEventHandler;
            Date.SettingDate += SettingDateEventHandler;
        ...
        protected virtual void SettingDateEventHandler(object sender, ElementActionEventArgs arg)
        {
        }
