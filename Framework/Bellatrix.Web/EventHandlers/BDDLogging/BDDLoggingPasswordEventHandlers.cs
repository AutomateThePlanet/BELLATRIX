...
namespace Bellatrix.Web.Extensions.Controls.Controls.EventHandlers
{
    public class BDDLoggingPasswordEventHandlers : PasswordEventHandlers
    {
        ...
        protected override void SettingPasswordEventHandler(object sender, ElementActionEventArgs arg) => Logger.LogInformation($"Type '{arg.ActionValue}' into {arg.Element.ElementName}".AddUrlOrPageToBddLogging(arg.Element.PageName));
