...
namespace Bellatrix.Web.Extensions.Controls.Controls.EventHandlers
{
    public class BDDLoggingMonthEventHandlers : MonthEventHandlers
    {
        ...
        protected override void SettingMonthEventHandler(object sender, ElementActionEventArgs arg) => Logger.LogInformation($"Set '{arg.ActionValue}' into {arg.Element.ElementName}".AddUrlOrPageToBddLogging(arg.Element.PageName));
