...
namespace Bellatrix.Web.Extensions.Controls.Controls.EventHandlers
{
    public class BugReportingCheckboxEventHandlers : CheckboxEventHandlers
    {
        ...
        protected override void CheckingEventHandler(object sender, ElementActionEventArgs arg) => BugReportingContextService.AddStep($"Check {arg.Element.ElementName}".AddDynamicTestCasesUsingLocatorsMessage(arg));

        protected override void UncheckingEventHandler(object sender, ElementActionEventArgs arg) => BugReportingContextService.AddStep($"Uncheck {arg.Element.ElementName}".AddDynamicTestCasesUsingLocatorsMessage(arg));
