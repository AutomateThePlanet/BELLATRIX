...
namespace Bellatrix.Web.Extensions.Controls.Controls.EventHandlers
{
    public class BugReportingMonthEventHandlers : MonthEventHandlers
    {
        ...
        protected override void SettingMonthEventHandler(object sender, ElementActionEventArgs arg) => BugReportingContextService.AddStep($"Set '{arg.ActionValue}' into {arg.Element.ElementName}".AddDynamicTestCasesUsingLocatorsMessage(arg));
