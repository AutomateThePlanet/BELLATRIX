...
namespace Bellatrix.Web.Extensions.Controls.Controls.EventHandlers
{
    public class DynamicTestCasesMonthEventHandlers : MonthEventHandlers
    {
        ...
        protected override void SettingMonthEventHandler(object sender, ElementActionEventArgs arg) => DynamicTestCasesService.AddStep($"Set '{arg.ActionValue}' into {arg.Element.ElementName}".AddDynamicTestCasesUsingLocatorsMessage(arg));
