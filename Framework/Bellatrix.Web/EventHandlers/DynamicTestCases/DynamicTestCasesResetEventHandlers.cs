// <copyright file="DynamicTestCasesResetEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class DynamicTestCasesResetEventHandlers : ResetEventHandlers
    {
