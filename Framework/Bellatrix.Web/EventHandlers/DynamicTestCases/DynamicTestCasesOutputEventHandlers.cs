// <copyright file="DynamicTestCasesOutputEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class DynamicTestCasesOutputEventHandlers : OutputEventHandlers
    {
