// <copyright file="DynamicTestCasesLabelEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class DynamicTestCasesLabelEventHandlers : LabelEventHandlers
    {
