// <copyright file="DynamicTestCasesAnchorEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class DynamicTestCasesAnchorEventHandlers : AnchorEventHandlers
    {
