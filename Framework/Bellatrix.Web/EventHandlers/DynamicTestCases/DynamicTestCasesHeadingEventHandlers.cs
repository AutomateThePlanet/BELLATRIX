// <copyright file="DynamicTestCasesHeadingEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class DynamicTestCasesHeadingEventHandlers : HeadingEventHandlers
    {
