// <copyright file="SpanControlDataHandler.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.Web.Controls.Advanced.ControlDataHandlers
{
    public class SpanControlDataHandler : IReadonlyControlDataHandler<Span>
    {
        ...
        public void EnsureValueIs(Span element, string expectedValue) => element.EnsureInnerTextIs(expectedValue);
    }
}