// <copyright file="ImageControlDataHandler.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.Web.Controls.Advanced.ControlDataHandlers
{
    public class ImageControlDataHandler : IReadonlyControlDataHandler<Image>
    {
        ...
        public void EnsureValueIs(Image element, string expectedValue) => element.EnsureSrcIs(expectedValue);
    }
}