// <copyright file="LogExceptionsWorkflowPlugin.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.TestExecutionExtensions.ExceptionsLogging
{
    public class LogExceptionsWorkflowPlugin : TestWorkflowPlugin
    {
