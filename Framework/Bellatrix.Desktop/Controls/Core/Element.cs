...
namespace Bellatrix.Desktop
{
    ...
    public partial class Element
    {
        ...
        public static Action<Element> OverrideScrollToVisibleGlobally;
        ...
        public static Action<Element> OverrideScrollToVisibleLocally;
        ...
        {
            var action = InitializeAction(this, OverrideScrollToVisibleGlobally, OverrideScrollToVisibleLocally, DefaultScrollToVisible);
            action();
        }
            ...
            if (_wrappedElement == null || shouldRefresh)
            {
                ...
                try
                {
                    foreach (var until in _untils)
                    {
                        ...
                        if (until.GetType().Equals(typeof(UntilNotExist)))
                        {
