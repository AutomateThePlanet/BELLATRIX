...
namespace Bellatrix.Desktop
{
   public class Menu : Element
    {
        public static Action<Menu> OverrideHoverGlobally;

        public static Action<Menu> OverrideHoverLocally;
        ...
        protected virtual void DefaultHover(Menu menu) => DefaultHover(menu, Hovering, Hovered);
    }
}