...
namespace Bellatrix.Desktop.Configuration
{
    ...
    {
        public static DesktopSettings GetDesktopSettings(this ConfigurationService service)
            => ConfigurationService.Instance.Root.GetSection("desktopSettings").Get<DesktopSettings>();
    }
}
