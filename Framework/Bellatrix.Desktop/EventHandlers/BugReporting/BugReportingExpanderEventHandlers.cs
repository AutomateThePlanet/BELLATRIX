// <copyright file="BugReportingExpanderEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class BugReportingExpanderEventHandlers : ExpanderEventHandlers
    {
