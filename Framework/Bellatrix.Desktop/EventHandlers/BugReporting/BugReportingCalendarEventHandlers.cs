// <copyright file="BugReportingCalendarEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class BugReportingCalendarEventHandlers : CalendarEventHandlers
    {
