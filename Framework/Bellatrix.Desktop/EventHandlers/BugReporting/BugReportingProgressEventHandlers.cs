// <copyright file="BugReportingProgressEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class BugReportingProgressEventHandlers : ProgressEventHandlers
    {
