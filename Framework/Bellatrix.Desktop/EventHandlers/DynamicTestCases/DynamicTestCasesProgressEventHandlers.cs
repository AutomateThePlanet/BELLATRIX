// <copyright file="DynamicTestCasesProgressEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class DynamicTestCasesProgressEventHandlers : ProgressEventHandlers
    {
