// <copyright file="DynamicTestCasesImageEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class DynamicTestCasesImageEventHandlers : ImageEventHandlers
    {
