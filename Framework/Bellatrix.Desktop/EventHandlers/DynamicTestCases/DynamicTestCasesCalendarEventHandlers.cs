// <copyright file="DynamicTestCasesCalendarEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class DynamicTestCasesCalendarEventHandlers : CalendarEventHandlers
    {
