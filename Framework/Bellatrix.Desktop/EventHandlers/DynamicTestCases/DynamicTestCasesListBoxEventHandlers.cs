// <copyright file="DynamicTestCasesListBoxEventHandlers.cs" company="Automate The Planet Ltd.">
...
{
    public class DynamicTestCasesListBoxEventHandlers : ListBoxEventHandlers
    {
