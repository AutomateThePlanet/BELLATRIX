// <copyright file="ValidatedPasswordIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedPasswordIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedPasswordIs";
