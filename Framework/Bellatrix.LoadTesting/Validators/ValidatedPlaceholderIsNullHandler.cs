// <copyright file="ValidatedPlaceholderIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedPlaceholderIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedPlaceholderIsNull";
