// <copyright file="ValidatedStyleContainsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedStyleContainsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedStyleContains";
