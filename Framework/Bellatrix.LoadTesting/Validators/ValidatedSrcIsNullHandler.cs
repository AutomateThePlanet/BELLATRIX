// <copyright file="ValidatedSrcIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSrcIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSrcIsNull";
