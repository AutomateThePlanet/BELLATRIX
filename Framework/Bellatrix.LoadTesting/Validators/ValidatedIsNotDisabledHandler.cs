// <copyright file="ValidatedIsNotDisabledHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedIsNotDisabledHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedIsNotDisabled";
