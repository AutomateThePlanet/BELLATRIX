// <copyright file="ValidatedMinLengthIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMinLengthIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMinLengthIsNull";
