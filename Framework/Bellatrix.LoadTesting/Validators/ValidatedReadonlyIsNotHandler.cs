// <copyright file="ValidatedReadonlyIsNotHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedReadonlyIsNotHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedReadonlyIsNot";
