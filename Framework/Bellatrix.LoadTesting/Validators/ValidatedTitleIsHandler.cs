// <copyright file="ValidatedTitleIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTitleIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTitleIs";
