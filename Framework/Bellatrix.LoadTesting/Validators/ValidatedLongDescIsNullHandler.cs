// <copyright file="ValidatedLongDescIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedLongDescIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedLongDescIsNull";
