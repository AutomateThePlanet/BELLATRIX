// <copyright file="ValidatedDisabledIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedDisabledIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedDisabledIs";
