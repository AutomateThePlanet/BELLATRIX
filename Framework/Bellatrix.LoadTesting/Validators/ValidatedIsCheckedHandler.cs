// <copyright file="ValidatedIsCheckedHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedIsCheckedHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedIsChecked";
