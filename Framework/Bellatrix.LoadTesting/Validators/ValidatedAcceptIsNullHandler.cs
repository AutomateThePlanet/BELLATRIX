// <copyright file="ValidatedAcceptIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedAcceptIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedAcceptIsNull";
