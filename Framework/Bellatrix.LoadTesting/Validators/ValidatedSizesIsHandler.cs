// <copyright file="ValidatedSizesIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSizesIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSizesIs";
