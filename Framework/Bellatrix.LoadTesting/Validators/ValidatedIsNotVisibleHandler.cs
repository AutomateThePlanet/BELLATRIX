// <copyright file="ValidatedIsNotVisibleHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedIsNotVisibleHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedIsNotVisible";
