// <copyright file="ValidatedTitleIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTitleIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTitleIsNull";
