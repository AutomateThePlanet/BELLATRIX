// <copyright file="ValidatedTextIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTextIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTextIs";
