// <copyright file="ValidatedPlaceholderIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedPlaceholderIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedPlaceholderIs";
