// <copyright file="ValidatedWrapIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedWrapIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedWrapIsNull";
