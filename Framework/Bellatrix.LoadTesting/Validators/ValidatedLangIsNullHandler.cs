// <copyright file="ValidatedLangIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedLangIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedLangIsNull";
