// <copyright file="ValidatedSrcSetIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSrcSetIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSrcSetIsNull";
