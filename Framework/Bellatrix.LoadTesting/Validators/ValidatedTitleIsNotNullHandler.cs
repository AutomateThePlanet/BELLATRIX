// <copyright file="ValidatedTitleIsNotNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTitleIsNotNullHandler
        : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTitleIsNotNull";
