// <copyright file="ValidatedListIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedListIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedListIsNull";
