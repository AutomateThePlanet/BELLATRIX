// <copyright file="ValidatedMaxLengthIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMaxLengthIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMaxLengthIsNull";
