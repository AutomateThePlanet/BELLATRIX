// <copyright file="ValidatedAcceptIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedAcceptIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedAcceptIs";
