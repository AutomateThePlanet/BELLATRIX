// <copyright file="ValidatedDirIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedDirIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedDirIsNull";
