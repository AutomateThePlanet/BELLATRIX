// <copyright file="ValidatedSrcSetIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSrcSetIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSrcSetIs";
