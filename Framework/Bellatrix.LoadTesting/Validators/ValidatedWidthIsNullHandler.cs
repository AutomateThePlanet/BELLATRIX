// <copyright file="ValidatedWidthIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedWidthIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedWidthIsNull";
