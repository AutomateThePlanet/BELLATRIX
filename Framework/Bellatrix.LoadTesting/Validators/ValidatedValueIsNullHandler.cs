// <copyright file="ValidatedValueIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedValueIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedValueIsNull";
