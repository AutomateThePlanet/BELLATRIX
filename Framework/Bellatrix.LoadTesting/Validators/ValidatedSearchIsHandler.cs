// <copyright file="ValidatedSearchIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSearchIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSearchIs";
