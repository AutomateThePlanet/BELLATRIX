// <copyright file="ValidatedStyleNotContainsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedStyleNotContainsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedStyleNotContains";
