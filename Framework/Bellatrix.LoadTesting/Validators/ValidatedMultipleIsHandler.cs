// <copyright file="ValidatedMultipleIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMultipleIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMultipleIs";
