// <copyright file="ValidatedStyleIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedStyleIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedStyleIsNull";
