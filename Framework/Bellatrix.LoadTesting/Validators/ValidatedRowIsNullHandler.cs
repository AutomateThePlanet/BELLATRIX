// <copyright file="ValidatedRowIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedRowIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedRowIsNull";
