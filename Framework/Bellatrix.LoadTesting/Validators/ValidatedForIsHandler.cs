// <copyright file="ValidatedForIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedForIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedForIs";
