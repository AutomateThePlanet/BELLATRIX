// <copyright file="ValidateIsVisibleHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidateIsVisibleHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedIsVisible";
        ...
        public override ResponseAssertionResults Execute(LoadTestElement loadTestElement, string expectedValue)
        {
            ...
            {
                responseAssertionResults.AssertionType = $"{ValidateType}- {loadTestElement.Locator}={loadTestElement.LocatorValue}";
