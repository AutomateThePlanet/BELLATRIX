// <copyright file="ValidatedWidthIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedWidthIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedWidthIs";
