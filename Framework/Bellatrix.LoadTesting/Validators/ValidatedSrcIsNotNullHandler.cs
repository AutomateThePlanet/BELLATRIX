// <copyright file="ValidatedSrcIsNotNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSrcIsNotNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSrcIsNotNull";
