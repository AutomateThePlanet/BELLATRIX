// <copyright file="ValidateInnerTextContainsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidateInnerTextContainsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedInnerTextContains";
