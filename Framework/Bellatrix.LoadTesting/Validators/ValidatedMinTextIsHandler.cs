// <copyright file="ValidatedMinTextIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMinTextIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMinTextIs";
