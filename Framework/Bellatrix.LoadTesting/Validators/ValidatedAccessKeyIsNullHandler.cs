// <copyright file="ValidatedAccessKeyIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedAccessKeyIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedAccessKeyIsNull";
