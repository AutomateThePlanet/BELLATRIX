// <copyright file="ValidatedCssClassIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedCssClassIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedCssClassIs";
