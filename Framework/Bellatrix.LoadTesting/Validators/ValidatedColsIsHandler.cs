// <copyright file="ValidatedColsIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedColsIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedColsIs";
