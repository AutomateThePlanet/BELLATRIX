// <copyright file="ValidatedSizeIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSizeIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSizeIs";
