// <copyright file="ValidatedStepIsEventHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedStepIsEventHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedStepIsEvent";
