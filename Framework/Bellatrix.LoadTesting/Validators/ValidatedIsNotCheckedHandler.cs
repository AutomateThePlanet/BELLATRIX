// <copyright file="ValidatedIsNotCheckedHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedIsNotCheckedHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedIsNotChecked";
