// <copyright file="ValidatedRowIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedRowIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedRowIs";
