// <copyright file="ValidatedHrefIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedHrefIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedHrefIs";
