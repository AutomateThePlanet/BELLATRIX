// <copyright file="ValidatedRangeIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedRangeIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedRangeIs";
