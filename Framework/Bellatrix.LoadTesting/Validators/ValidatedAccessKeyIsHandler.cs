// <copyright file="ValidatedAccessKeyIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedAccessKeyIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedAccessKeyIs";
