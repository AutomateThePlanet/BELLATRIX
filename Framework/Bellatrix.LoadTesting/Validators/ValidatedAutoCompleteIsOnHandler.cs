// <copyright file="ValidatedAutoCompleteIsOnHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedAutoCompleteIsOnHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedAutoCompleteIsOn";
