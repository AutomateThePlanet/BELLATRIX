// <copyright file="ValidatedSizesIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSizesIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSizesIsNull";
