// <copyright file="ValidatedTargetIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTargetIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedIsNull";
