// <copyright file="ValidatedHeightIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedHeightIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedHeightIs";
