// <copyright file="ValidatedAltIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedAltIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedAltIs";
