// <copyright file="ValidateInnerHtmlIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidateInnerHtmlIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidateInnerHtmlIs";
