// <copyright file="ValidatedUrlIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedUrlIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedUrlIs";
