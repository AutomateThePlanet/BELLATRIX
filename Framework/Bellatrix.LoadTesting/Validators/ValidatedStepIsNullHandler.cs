// <copyright file="ValidatedStepIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedStepIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedStepIsNull";
