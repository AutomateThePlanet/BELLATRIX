// <copyright file="ValidatedMinLengthIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMinLengthIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMinLengthIs";
