// <copyright file="ValidatedValueIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedValueIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedValueIs";
