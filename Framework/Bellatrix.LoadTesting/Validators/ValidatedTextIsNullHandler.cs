// <copyright file="ValidatedTextIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTextIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTextIsNull";
