// <copyright file="ValidatedIsSelectedHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedIsSelectedHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedIsSelected";
