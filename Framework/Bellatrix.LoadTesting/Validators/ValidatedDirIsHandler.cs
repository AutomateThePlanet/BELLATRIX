// <copyright file="ValidatedDirIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedDirIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedDirIs";
