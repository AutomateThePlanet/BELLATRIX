// <copyright file="ValidatedListIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedListIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedListIs";
