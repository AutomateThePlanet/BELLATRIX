// <copyright file="ValidatedRequiredIsNotHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedRequiredIsNotHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedRequiredIsNot";
