// <copyright file="ValidatedPhoneIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedPhoneIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedPhoneIs";
