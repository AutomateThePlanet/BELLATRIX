// <copyright file="ValidatedColorIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedColorIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedColorIs";
