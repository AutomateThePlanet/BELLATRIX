// <copyright file="ValidatedWrapIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedWrapIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedWrapIs";
