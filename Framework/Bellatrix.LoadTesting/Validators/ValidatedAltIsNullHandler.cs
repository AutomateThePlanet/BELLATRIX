// <copyright file="ValidatedAltIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedAltIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedAltIsNull";
