// <copyright file="ValidatedMaxLengthIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMaxLengthIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMaxLengthIs";
