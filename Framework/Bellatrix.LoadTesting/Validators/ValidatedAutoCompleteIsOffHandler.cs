// <copyright file="ValidatedAutoCompleteIsOffHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedAutoCompleteIsOffHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedAutoCompleteIsOff";
