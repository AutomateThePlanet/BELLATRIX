// <copyright file="ValidatedTimeIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTimeIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTimeIs";
