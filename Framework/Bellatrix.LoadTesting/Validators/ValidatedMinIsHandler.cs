// <copyright file="ValidatedMinIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMinIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMinIs";
