// <copyright file="ValidatedSrcIsEventHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSrcIsEventHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSrcIsEvent";
