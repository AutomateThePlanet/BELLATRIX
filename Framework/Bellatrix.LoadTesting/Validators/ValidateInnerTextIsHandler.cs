// <copyright file="ValidateInnerTextIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidateInnerTextIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedInnerTextIs";
