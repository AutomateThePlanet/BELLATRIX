// <copyright file="ValidatedHeightIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedHeightIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedHeightIsNull";
