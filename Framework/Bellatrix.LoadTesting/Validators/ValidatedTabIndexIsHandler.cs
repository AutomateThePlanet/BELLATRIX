// <copyright file="ValidatedTabIndexIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTabIndexIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTabIndexIs";
