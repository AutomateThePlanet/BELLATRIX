// <copyright file="ValidatedSpellCheckIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSpellCheckIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSpellCheckIsNull";
