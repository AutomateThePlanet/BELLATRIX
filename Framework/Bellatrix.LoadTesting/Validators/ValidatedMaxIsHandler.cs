// <copyright file="ValidatedMaxIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMaxIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMaxIs";
