// <copyright file="ValidatedWeekIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedWeekIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedWeekIs";
