// <copyright file="ValidatedMonthIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMonthIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMonthIs";
