// <copyright file="ValidatedMinIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMinIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMinIsNull";
