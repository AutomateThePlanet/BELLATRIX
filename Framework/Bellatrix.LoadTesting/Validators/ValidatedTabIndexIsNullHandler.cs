// <copyright file="ValidatedTabIndexIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTabIndexIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTabIndexIsNull";
