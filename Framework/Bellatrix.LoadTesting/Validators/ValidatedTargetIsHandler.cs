// <copyright file="ValidatedTargetIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTargetIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTargetIs";
