// <copyright file="ValidatedRelIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedRelIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedRelIsNull";
