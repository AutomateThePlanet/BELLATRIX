// <copyright file="ValidatedLangIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedLangIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedLangIs";
