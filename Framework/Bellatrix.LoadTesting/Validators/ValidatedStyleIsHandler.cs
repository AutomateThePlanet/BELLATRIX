// <copyright file="ValidatedStyleIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedStyleIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedStyleIs";
