// <copyright file="ValidatedCssClassIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedCssClassIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedCssClassIsNull";
