// <copyright file="ValidatedRequiredIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedRequiredIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedRequiredIs";
