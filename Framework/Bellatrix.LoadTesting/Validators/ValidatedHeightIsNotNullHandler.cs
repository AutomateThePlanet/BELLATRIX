// <copyright file="ValidatedHeightIsNotNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedHeightIsNotNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedHeightIsNotNull";
