// <copyright file="ValidatedMultipleIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMultipleIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMultipleIsNull";
