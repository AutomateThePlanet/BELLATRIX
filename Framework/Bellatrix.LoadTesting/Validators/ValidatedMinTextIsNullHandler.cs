// <copyright file="ValidatedMinTextIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMinTextIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMinTextIsNull";
