// <copyright file="ValidatedForIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedForIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedForIsNull";
