// <copyright file="ValidatedSizeIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedSizeIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedSizeIsNull";
