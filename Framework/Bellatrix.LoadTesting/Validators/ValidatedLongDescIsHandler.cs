// <copyright file="ValidatedLongDescIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedLongDescIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedLongDescIs";
