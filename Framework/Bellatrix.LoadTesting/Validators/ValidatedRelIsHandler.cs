// <copyright file="ValidatedRelIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedRelIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedRelIs";
