// <copyright file="ValidatedWidthIsNotNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedWidthIsNotNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedWidthIsNotNull";
