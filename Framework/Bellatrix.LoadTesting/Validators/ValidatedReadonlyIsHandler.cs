// <copyright file="ValidatedReadonlyIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedReadonlyIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedReadonlyIs";
