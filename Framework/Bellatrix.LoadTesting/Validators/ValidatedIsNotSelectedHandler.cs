// <copyright file="ValidatedIsNotSelectedHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedIsNotSelectedHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedIsNotSelected";
