// <copyright file="ValidatedEmailIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedEmailIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedEmailIs";
