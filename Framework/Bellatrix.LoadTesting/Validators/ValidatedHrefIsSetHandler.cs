// <copyright file="ValidatedHrefIsSetHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedHrefIsSetHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedHrefIsSet";
