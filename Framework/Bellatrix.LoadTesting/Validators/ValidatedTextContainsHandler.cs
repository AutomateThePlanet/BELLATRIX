// <copyright file="ValidatedTextContainsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTextContainsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTextContains";
