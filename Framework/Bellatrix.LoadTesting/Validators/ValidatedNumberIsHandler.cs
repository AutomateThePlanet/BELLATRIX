// <copyright file="ValidatedNumberIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedNumberIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedNumberIs";
