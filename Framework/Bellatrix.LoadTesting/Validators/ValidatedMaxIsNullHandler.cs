// <copyright file="ValidatedMaxIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedMaxIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedMaxIsNull";
