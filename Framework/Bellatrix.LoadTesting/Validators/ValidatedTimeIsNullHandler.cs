// <copyright file="ValidatedTimeIsNullHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedTimeIsNullHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedTimeIsNull";
