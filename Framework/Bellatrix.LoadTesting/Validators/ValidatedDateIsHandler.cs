// <copyright file="ValidatedDateIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class ValidatedDateIsHandler : LoadTestValidateHandler
    {
        public override string ValidateType => "ValidatedDateIs";
