// <copyright file="ByXPathLoadTestLocator.cs" company="Automate The Planet Ltd.">
...
{
    public class ByXPathLoadTestLocator : LoadTestLocator
    {
        public override string LocatorType => "Bellatrix.Web.ByXpath";
