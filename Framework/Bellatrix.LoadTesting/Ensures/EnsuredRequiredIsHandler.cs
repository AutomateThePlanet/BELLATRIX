// <copyright file="EnsuredRequiredIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class EnsuredRequiredIsHandler : LoadTestEnsureHandler
    {
        public override string EnsureType => "EnsuredRequiredIs";
        ...
        public override ResponseAssertionResults Execute(LoadTestElement loadTestElement, string expectedValue)
        {
            ...
            if (loadTestElement.HtmlNode.GetAttributeValue("required", string.Empty) != expectedValue)
            {
                ...
                responseAssertionResults.FailedMessage = $"Element with locator {loadTestElement.Locator}={loadTestElement.LocatorValue} required wasn't equal to {expectedValue}.";
            }
