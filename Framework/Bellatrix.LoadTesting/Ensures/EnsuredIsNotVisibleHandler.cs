// <copyright file="EnsuredIsNotVisibleHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class EnsuredIsNotVisibleHandler : LoadTestEnsureHandler
    {
        public override string EnsureType => "EnsuredIsNotVisible";
        ...
        public override ResponseAssertionResults Execute(LoadTestElement loadTestElement, string expectedValue)
        {
            ...
            if (loadTestElement.HtmlNode == null)
            {
                ...
                responseAssertionResults.FailedMessage = $"Element with locator {loadTestElement.Locator}={loadTestElement.LocatorValue} was visible.";
            }
