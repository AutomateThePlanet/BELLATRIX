// <copyright file="EnsuredTextIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class EnsuredTextIsHandler : LoadTestEnsureHandler
    {
        public override string EnsureType => "EnsuredTextIs";
