// <copyright file="EnsuredSpellCheckIsHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class EnsuredSpellCheckIsHandler : LoadTestEnsureHandler
    {
        public override string EnsureType => "EnsuredSpellCheckIs";
