// <copyright file="EnsureIsVisibleHandler.cs" company="Automate The Planet Ltd.">
...
{
    public class EnsureIsVisibleHandler : LoadTestEnsureHandler
    {
        ...
        public override ResponseAssertionResults Execute(LoadTestElement loadTestElement, string expectedValue)
        {
            ...
            {
                responseAssertionResults.AssertionType = $"{EnsureType}- {loadTestElement.Locator}={loadTestElement.LocatorValue}";
