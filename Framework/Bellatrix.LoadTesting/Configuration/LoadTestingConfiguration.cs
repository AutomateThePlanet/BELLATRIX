// <copyright file="LoadTestingConfiguration.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.LoadTesting.Configuration
{
    public class LoadTestingConfiguration
    {
        public LoadTestingConfiguration()
        {
