...
namespace Bellatrix.Mobile.DynamicTestCases.Android
{
    public class DynamicTestCasesNumberEventHandlers : NumberEventHandlers
    {
        ...
        protected override void SettingNumberEventHandler(object sender, ElementActionEventArgs<AndroidElement> arg) => DynamicTestCasesService.AddStep($"Type '{arg.ActionValue}' into {arg.Element.ElementName} on {arg.Element.PageName}");
    }
}