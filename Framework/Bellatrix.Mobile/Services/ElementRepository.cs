...
namespace Bellatrix.Mobile.Services
{
    internal class ElementRepository
    {
        ...
        {
            DetermineElementAttributes<TDriver, TDriverElement>(out var elementName, out var pageName);
        ...
        private void DetermineElementAttributes<TDriver, TDriverElement>(out string elementName, out string pageName)
            where TDriver : AppiumDriver<TDriverElement>
            where TDriverElement : AppiumWebElement
        {
