...
namespace Bellatrix.Mobile.IOS
{
    ...
    {
        public static Func<Tabs<TElement>, string, ElementsList<TElement, ByClassName, IOSDriver<IOSElement>, IOSElement>> OverrideGetAllGlobally;

        public static Func<Tabs<TElement>, string, ElementsList<TElement, ByClassName, IOSDriver<IOSElement>, IOSElement>> OverrideGetAllLocally;
        ...
        protected virtual ElementsList<TElement, ByClassName, IOSDriver<IOSElement>, IOSElement> DefaultGetAllOptions(Tabs<TElement> tabs, string searchClass)
        {
