   ...
   public class ToggleButton : Element, IElementDisabled, IElementOn, IElementText
    {
        ...
        protected virtual string DefaultText(ToggleButton toggleButton) => DefaultGetValue(toggleButton);

        protected virtual bool DefaultIsDisabled(ToggleButton toggleButton) => !WrappedElement.Enabled;

        protected virtual bool DefaultIsOn(ToggleButton toggleButton) => DefaultIsCheckedValue(toggleButton);
    }
}