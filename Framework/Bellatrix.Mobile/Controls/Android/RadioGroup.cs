  ...
  public class RadioGroup : Element
    {
        ...
        public static Func<RadioGroup, ElementsList<RadioButton, ByClassName, AndroidDriver<AndroidElement>, AndroidElement>> OverrideGetAllGlobally;
        ...
        public static Func<RadioGroup, ElementsList<RadioButton, ByClassName, AndroidDriver<AndroidElement>, AndroidElement>> OverrideGetAllLocally;
        ...
        public ElementsList<RadioButton, ByClassName, AndroidDriver<AndroidElement>, AndroidElement> GetAll()
        {
            var action = InitializeAction(this, OverrideGetAllGlobally, OverrideGetAllLocally, DefaultGetAllOptions);
            return action();
        }

        protected virtual ElementsList<RadioButton, ByClassName, AndroidDriver<AndroidElement>, AndroidElement> DefaultGetAllOptions(RadioGroup radioGroup)
        {
            var radioButtons = radioGroup.CreateAllByClass<RadioButton>("android.widget.RadioButton");
        ...
        {
            var clickedRadioButton = radioGroup.CreateByXPath<RadioButton>("//*[@checked='true']");
