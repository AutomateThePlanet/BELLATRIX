...
namespace Bellatrix.Mobile.IOS
{
    public class ByFactory
    {
        ...
        public ByIOSUIAutomation IOSUIAutomation(string name) => new ByIOSUIAutomation(name);

        public ByValueContaining ValueContaining(string name) => new ByValueContaining(name);
    }
}
