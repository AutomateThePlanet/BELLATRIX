...
{
    public class ByValueContaining : By<IOSDriver<IOSElement>, IOSElement>
    {
        private readonly string _locatorValue;

        public ByValueContaining(string name)
            : base(name)
        ...
        public override string ToString() => $"Value contains {Value}";
    }
}
