...
{
    public class ByDescriptionContaining : By<AndroidDriver<AndroidElement>, AndroidElement>
    {
        private readonly string _locatorValue;

        public ByDescriptionContaining(string name)
            : base(name)
        ...
        public override string ToString() => $"Description contains {Value}";
    }
}
