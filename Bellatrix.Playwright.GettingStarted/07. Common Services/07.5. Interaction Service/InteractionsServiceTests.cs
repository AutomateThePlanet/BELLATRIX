...
public class InteractionsServiceTests : NUnit.WebTest
{
    ...
    public void KeyUp()
    {
        ...
        // TODO key up????
        App.Interactions.MoveToElement(protonRocketAnchor).KeyUp("Shift").ContextClick().Perform();
        App.Interactions.DoubleClick(protonRocketAnchor).KeyUp("Shift").ContextClick().Perform();
    }
}