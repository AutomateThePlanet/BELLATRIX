...
public class LocateElementsTests : NUnit.WebTest
{
    ...
    public void PromotionsPageOpened_When_PromotionsButtonClicked()
    {
        ...
        // In vanilla Playwright to type the text you call FillAsync method.
        //
    ...
    {
        // TODO: When the native playwright finding strategies are implemented, they should be shown here!

        App.Navigation.Navigate("https://demos.bellatrix.solutions/");

        // 4. BELLATRIX extends the vanilla Playwright selectors and gives you additional ones.
