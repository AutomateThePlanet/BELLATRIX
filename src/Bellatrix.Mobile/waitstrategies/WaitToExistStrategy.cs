   ...
   where TDriverElement : AppiumElement
{
    ...
    {
        TimeoutInterval = timeoutInterval ?? ConfigurationService.GetSection<MobileSettings>().TimeoutSettings.ElementToExistTimeout;
    }
    ...
    private bool ElementExists<TBy>(TDriver searchContext, TBy by)
