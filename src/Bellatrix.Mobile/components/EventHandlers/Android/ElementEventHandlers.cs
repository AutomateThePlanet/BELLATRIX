...
namespace Bellatrix.Mobile.EventHandlers.Android
{
    public class ElementEventHandlers : IControlEventHandlers
    {
        ...
        protected virtual void ScrollingToVisibleEventHandler(object sender, ElementActionEventArgs<AndroidElement> arg)
        {
        }

        protected virtual void ScrolledToVisibleEventHandler(object sender, ElementActionEventArgs<AndroidElement> arg)
        {
        }

        protected virtual void CreatingElementEventHandler(object sender, ElementActionEventArgs<AndroidElement> arg)
        {
        }

        protected virtual void CreatedElementEventHandler(object sender, ElementActionEventArgs<AndroidElement> arg)
        {
        }

        protected virtual void CreatingElementsEventHandler(object sender, ElementActionEventArgs<AndroidElement> arg)
        {
        }

        protected virtual void CreatedElementsEventHandler(object sender, ElementActionEventArgs<AndroidElement> arg)
        {
        }
