...
public static partial class ValidateControlExtensions
{
    ...
    {
        ValidateControlWaitService.WaitUntil<AndroidDriver, AppiumElement>(() => control.IsVisible.Equals(true), "The control should be visible but was NOT.", timeout, sleepInterval);
    ...
    public static void ValidateIsNotVisible<T>(this T control, int? timeout = null, int? sleepInterval = null)
        where T : IComponentVisible, IComponent<AppiumElement>
    {
        ValidateControlWaitService.WaitUntil<AndroidDriver, AppiumElement>(() => !control.IsVisible.Equals(true), "The control should be NOT visible but was NOT.", timeout, sleepInterval);
