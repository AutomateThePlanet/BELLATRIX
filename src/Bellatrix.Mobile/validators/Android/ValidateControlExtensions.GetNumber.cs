...
namespace Bellatrix.Mobile.Android
{
    public static partial class ValidateControlExtensions
    {
                ...
                where T : IElementNumber, IElement<AndroidElement>
        {
            ...
            ValidatedNumberIsEvent?.Invoke(control, new ElementActionEventArgs<AndroidElement>(control, value.ToString()));
        }

        public static event EventHandler<ElementActionEventArgs<AndroidElement>> ValidatedNumberIsEvent;
    }
}