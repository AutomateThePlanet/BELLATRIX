...
namespace Bellatrix.Mobile
{
    ...
    {
        public AndroidAttribute(string appPath, string platformVersion, string deviceName, string appPackage, string appActivity, AppBehavior behavior = AppBehavior.NotSet)
