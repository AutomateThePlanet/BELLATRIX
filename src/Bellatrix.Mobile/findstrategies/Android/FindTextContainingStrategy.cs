// <copyright file="ByTextContaining.cs" company="Automate The Planet Ltd.">
...
{
    public class FindTextContainingStrategy : FindStrategy<AndroidDriver<AndroidElement>, AndroidElement>
    {
        private readonly string _locatorValue;

        public FindTextContainingStrategy(string name)
            : base(name)
        {
