...
namespace Bellatrix.Desktop.BddLogging
{
    ...
    {
        protected override void SettingPasswordEventHandler(object sender, ElementActionEventArgs arg) => Logger.LogInformation($"Type '{arg.ActionValue}' into {arg.Element.ElementName} on {arg.Element.PageName}");
    }
}
