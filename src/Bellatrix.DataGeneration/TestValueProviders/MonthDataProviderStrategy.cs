...
public class MonthDataProviderStrategy : DataProviderStrategy<DateTime>
{
    ...
    {
        var monthString = boundaryInput.ToString("yyyy-MM", CultureInfo.InvariantCulture);
        return new TestValue(monthString, typeof(string), category);
    }
