...
namespace Bellatrix.Web
{
    public static partial class ValidateControlExtensions
    {
            ...
            where T : IElementWrap, IElement
        {
            ...
            ValidatedWrapIsNullEvent?.Invoke(control, new ElementActionEventArgs(control));
        }
            ...
            where T : IElementWrap, IElement
        {
            ...
            ValidatedWrapIsEvent?.Invoke(control, new ElementActionEventArgs(control, value));
        }

        public static event EventHandler<ElementActionEventArgs> ValidatedWrapIsNullEvent;
        public static event EventHandler<ElementActionEventArgs> ValidatedWrapIsEvent;
    }
}