...
namespace Bellatrix.Web
{
    public static partial class ValidateControlExtensions
    {
            ...
            where T : IElementTime, IElement
        {
            ...
            ValidatedTimeIsEvent?.Invoke(control, new ElementActionEventArgs(control, value));
        }

        public static event EventHandler<ElementActionEventArgs> ValidatedTimeIsEvent;
    }
}