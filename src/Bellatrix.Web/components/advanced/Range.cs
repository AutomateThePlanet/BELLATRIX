...
{
    public class Range : Component, IElementDisabled, IElementValue, IElementRange, IElementList, IElementAutoComplete, IElementRequired, IElementMax, IElementMin, IElementStep
    {
