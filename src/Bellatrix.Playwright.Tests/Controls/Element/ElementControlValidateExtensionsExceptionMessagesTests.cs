...
{
    private string _url = ConfigurationService.GetSection<TestPagesSettings>().ElementPage;
    ...
    {
        var element = App.Components.CreateById<Bellatrix.Playwright.Component>("myURL11");
