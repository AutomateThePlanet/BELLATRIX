...
[Browser(OS.OSX, BrowserTypes.Webkit, Lifecycle.ReuseIfStarted)]
[AllureSuite("Table Control")]
public class TableControlTestsChrome : MSTest.WebTest
{
    public override void TestInit()
        => App.Navigation.NavigateToLocalPage(ConfigurationService.GetSection<TestPagesSettings>().TablePage);
    ...
    {
        var table = App.Components.CreateById<Playwright.Table>("simpleTable");
    ...
    {
        var table = App.Components.CreateById<Playwright.Table>("nestedTable");
        table.SetColumn("Last Name");
        table.SetColumn("First Name");
        table.SetColumn("Email");
        table.SetColumn("Due");
