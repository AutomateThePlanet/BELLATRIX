// <copyright file="PhoneControlValidateExtensionsExceptionMessagesTests.cs" company="Automate The Planet Ltd.">
...
{
    private string _url = ConfigurationService.GetSection<TestPagesSettings>().PhonePage;
