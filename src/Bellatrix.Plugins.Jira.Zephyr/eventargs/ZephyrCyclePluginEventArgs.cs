// <copyright file="ZephyrCyclePluginEventArgs.cs" company="Automate The Planet Ltd.">
...
public class ZephyrCyclePluginEventArgs : PluginEventArgs
{
    public ZephyrCyclePluginEventArgs()
    {
    }

    public ZephyrCyclePluginEventArgs(PluginEventArgs pluginEventArgs, ZephyrTestCycle testCycle)
        : base(pluginEventArgs.TestOutcome,
            ...
            pluginEventArgs.Descriptions) => TestCycle = testCycle;

    public ZephyrTestCycle TestCycle { get; }
}