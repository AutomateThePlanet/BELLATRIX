...
{
    protected override void SettingTimeEventHandler(object sender, ComponentActionEventArgs arg) => this.BugReportingContextService.AddStep($"Set '{arg.ActionValue}' into {arg.Element.ComponentName} on {arg.Element.PageName}");
}
