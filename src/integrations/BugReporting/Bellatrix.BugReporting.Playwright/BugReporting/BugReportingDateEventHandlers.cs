...
{
    protected override void SettingDateEventHandler(object sender, ComponentActionEventArgs arg) => this.BugReportingContextService.AddStep($"Set '{arg.ActionValue}' into {arg.Element.ComponentName}".AddDynamicTestCasesUsingLocatorsMessage(arg));
}
