...
public class DynamicTestCasesAssertionExtensions : AssertionsExtensionsEventHandlers
{
    ...
    {
        var bugReportingLayoutAssertionsExtensions = new DynamicTestCasesAssertionExtensions();
    ...
    protected override void AssertedAboveOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is above of {arg.SecondElement.ComponentName}.");

    protected override void AssertedAboveOfEventHandler(object sender, LayoutTwoComponentsActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px above of {arg.SecondElement.ComponentName}.");

    protected override void AssertedAboveOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px above of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedAboveOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px above of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedBelowOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is below of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedBelowOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px below of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedBottomInsideOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px bottom inside of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedHeightApproximateSecondElementEventHandler(object sender, LayoutTwoComponentsActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} height ", $"is ~{arg.ActionValue}% of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedLeftInsideOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is left inside of {arg.SecondElement.ComponentName}.");

    protected override void AssertedLeftInsideOfEventHandler(object sender, LayoutTwoComponentsActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px left inside of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedLeftInsideOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px left inside of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedLeftInsideOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px left inside of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedLeftOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is left of {arg.SecondElement.ComponentName}.");

    protected override void AssertedLeftOfEventHandler(object sender, LayoutTwoComponentsActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px left of {arg.SecondElement.ComponentName}.");

    protected override void AssertedLeftOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px left of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedLeftOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px left of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedNearBottomOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is near bottom of {arg.SecondElement.ComponentName}.");

    protected override void AssertedNearBottomOfEventHandler(object sender, LayoutTwoComponentsActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px near bottom of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedNearBottomOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px near bottom of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedNearBottomOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px near bottom of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedNearLeftOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is near left of {arg.SecondElement.ComponentName}.");

    protected override void AssertedNearLeftOfEventHandler(object sender, LayoutTwoComponentsActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px near left of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedNearLeftOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px near left of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedNearLeftOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px near left of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedNearRightOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is near right of {arg.SecondElement.ComponentName}.");

    protected override void AssertedNearRightOfEventHandler(object sender, LayoutTwoComponentsActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px near right of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedNearRightOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px near right of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedNearRightOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px near right of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedNearTopOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is near top of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedNearTopOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px near top of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedNearTopOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px near top of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedRightInsideOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is right inside of {arg.SecondElement.ComponentName}.");

    protected override void AssertedRightInsideOfEventHandler(object sender, LayoutTwoComponentsActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px right inside of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedRightInsideOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px right inside of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedRightInsideOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px right inside of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedRightOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is right of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedRightOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px right of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedRightOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px right of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedTopInsideOfNoExpectedValueEventHandler(object sender, LayoutTwoComponentsNoExpectedActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is top inside of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedTopInsideOfBetweenEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue}-{arg.SecondActionValue} px top inside of {arg.SecondElement.ComponentName}.");
    ...
    protected override void AssertedTopInsideOfApproximateEventHandler(object sender, LayoutTwoComponentsActionTwoValuesEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} ", $"is {arg.ActionValue} px top inside of {arg.SecondElement.ComponentName}. ({arg.SecondActionValue}% tolerance)");
    ...
    protected override void AssertedWidthBetweenEventHandler(object sender, LayoutComponentTwoValuesActionEventArgs arg)
        => DynamicTestCasesService.AddAssertStep($"Assert {arg.Element.ComponentName} width ", $"is {arg.ActionValue}-{arg.SecondActionValue} px.");
