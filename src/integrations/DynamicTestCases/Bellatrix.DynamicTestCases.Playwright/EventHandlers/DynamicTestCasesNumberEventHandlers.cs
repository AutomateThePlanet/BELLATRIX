...
{
    protected override void SettingNumberEventHandler(object sender, ComponentActionEventArgs arg) => this.DynamicTestCasesService.AddStep($"Set '{arg.ActionValue}' into {arg.Element.ComponentName}".AddDynamicTestCasesUsingLocatorsMessage(arg));
}
