...
namespace Bellatrix.Mobile.IOS.Tests
{
    ...
    public class ToggleButtonControlTests : MSTest.IOSTest
    {
        ...
        public void IsOnTrue_When_ToggleButtonTurnedOffAndTurnOn()
        {
            ...
            var toggleButton = App.ComponentCreateService.CreateByXPath<ToggleButton>("type == \"XCUIElementTypeSwitch\" AND name == \"All-day\"");
        ...
        public void IsOnFalse_When_ToggleButtonTurnedOnAndTurnOff()
        {
            ...
            var toggleButton = App.ComponentCreateService.CreateByIOSNsPredicate<ToggleButton>("type == \"XCUIElementTypeSwitch\" AND name == \"All-day\"");
