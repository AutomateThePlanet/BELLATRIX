...
namespace Bellatrix.Desktop.Tests
{
    ...
    public class TextAreaControlTestsWpf : BellatrixBaseTest
    {
        ...
        {
            var button = App.ComponentCreateService.CreateByAutomationId<TextArea>("textArea");
        ...
        {
            var textArea = App.ComponentCreateService.CreateByAutomationId<TextArea>("textArea");
        ...
        {
            var textArea = App.ComponentCreateService.CreateByAutomationId<TextArea>("disabledTextArea");
