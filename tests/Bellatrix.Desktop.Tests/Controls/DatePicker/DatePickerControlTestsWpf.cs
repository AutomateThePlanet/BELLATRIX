// <copyright file="DatePickerControlTestsWpf.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.Desktop.Tests
{
    ...
    public class DatePickerControlTestsWpf : BellatrixBaseTest
    {
        ...
        {
            var datePicker = App.ComponentCreateService.CreateByAutomationId<Date>("DatePickerDisabled");
