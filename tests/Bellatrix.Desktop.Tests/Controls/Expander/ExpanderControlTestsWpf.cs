...
namespace Bellatrix.Desktop.Tests
{
    ...
    public class ExpanderControlTestsWpf : BellatrixBaseTest
    {
        ...
        {
            var expander = App.ComponentCreateService.CreateByAutomationId<Expander>("HeaderSite");
        ...
        {
            var expander = App.ComponentCreateService.CreateAll<Expander, FindAutomationIdStrategy>(Find.By.AutomationId("HeaderSite")).Last();
