...
namespace Bellatrix.Desktop.Tests
{
    ...
    public class RadioControlTestsUniversal : BellatrixBaseTest
    {
        ...
        {
            var button = App.ElementCreateService.CreateByAutomationId<RadioButton>("radioButton");
        ...
        {
            var button = App.ElementCreateService.CreateByAutomationId<RadioButton>("selectedRadioButton");
