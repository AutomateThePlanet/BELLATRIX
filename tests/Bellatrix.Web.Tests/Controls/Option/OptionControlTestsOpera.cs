// <copyright file="OptionControlTestsOpera.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.Web.Tests.Controls
{
    ...
    public class OptionControlTestsOpera : MSTest.WebTest
    {
        public override void TestInit() => App.NavigationService.NavigateToLocalPage(SettingsService.GetSection<TestPagesSettings>().OptionLocalPage);

        [TestMethod]
        [TestCategory(Categories.Opera)]
        public void ReturnBellatrix_When_UseGetInnerTextMethod_Opera()
        {
        ...
        [TestMethod]
        [TestCategory(Categories.Opera)]
        public void ReturnBella_When_UseGetValueMethod_Opera()
        {
        ...
        [TestMethod]
        [TestCategory(Categories.Opera)]
        public void ReturnTrue_When_OptionSelectedAndCallGetIsSelectedMethod_Opera()
        {
            var selectElement = App.ElementCreateService.CreateById<Select>("mySelect");
        ...
        [TestMethod]
        [TestCategory(Categories.Opera)]
        public void ReturnFalse_When_OptionNotSelectedAndCallGetIsSelectedMethod_Opera()
        {
            var selectElement = App.ElementCreateService.CreateById<Select>("mySelect");
        ...
        [TestMethod]
        [TestCategory(Categories.Opera)]
        public void ReturnTrue_When_DisabledAttributeIsPresent_Opera()
        {
