// <copyright file="InputButtonControlTestsInternetExplorer.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.Web.Tests.Controls
{
    ...
    public class InputButtonControlTestsInternetExplorer : MSTest.WebTest
    {
