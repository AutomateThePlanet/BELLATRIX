// <copyright file="ResetControlTestsOpera.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.Web.Tests.Controls
{
    ...
    public class ResetControlTestsOpera : MSTest.WebTest
    {
        ...
        {
            var buttonElement = App.ComponentCreateService.CreateById<Reset>("myButton2");
