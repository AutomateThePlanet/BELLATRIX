// <copyright file="TextAreaControlTestsInternetExplorer.cs" company="Automate The Planet Ltd.">
...
namespace Bellatrix.Web.Tests.Controls
{
    ...
    public class TextAreaControlTestsInternetExplorer : MSTest.WebTest
    {
        public override void TestInit() => App.NavigationService.NavigateToLocalPage(SettingsService.GetSection<TestPagesSettings>().TextAreaLocalPage);
        ...
        [TestMethod]
        [Ignore, TestCategory(Categories.InternetExplorer), TestCategory(Categories.Windows)]
        public void GetRowsReturnsDefault2_When_RowsAttributeIsNotPresent_InternetExplorer()
        {
            var textAreaElement = App.ElementCreateService.CreateById<TextArea>("myTextArea");
        ...
        [TestMethod]
        [Ignore, TestCategory(Categories.InternetExplorer), TestCategory(Categories.Windows)]
        public void GetColsReturnsDefault20_When_ColsAttributeIsNotPresent_InternetExplorer()
        {
            var textAreaElement = App.ElementCreateService.CreateById<TextArea>("myTextArea");
        ...
        [TestMethod]
        [Ignore, TestCategory(Categories.InternetExplorer), TestCategory(Categories.Windows)]
        public void GetRowsReturns5_When_RowsAttributeIsNotPresent_InternetExplorer()
        {
        ...
        [TestMethod]
        [Ignore, TestCategory(Categories.InternetExplorer), TestCategory(Categories.Windows)]
        public void GetColsReturns5_When_ColsAttributeIsNotPresent_InternetExplorer()
        {
            var textAreaElement = App.ElementCreateService.CreateById<TextArea>("myTextArea11");
        ...
        [TestMethod]
        [Ignore, TestCategory(Categories.InternetExplorer), TestCategory(Categories.Windows)]
        public void GetWrap_When_WrapAttributeIsSet_InternetExplorer()
        {
        ...
        [TestMethod]
        [Ignore, TestCategory(Categories.InternetExplorer), TestCategory(Categories.Windows)]
        public void GetWrapReturnsNull_When_WrapAttributeIsNotPresent_InternetExplorer()
        {
            var textAreaElement = App.ElementCreateService.CreateById<TextArea>("myTextArea1");
        ...
        [TestMethod]
        [Ignore, TestCategory(Categories.InternetExplorer), TestCategory(Categories.Windows)]
        public void GetSpellCheck_When_SpellCheckAttributeIsSet_InternetExplorer()
        {
        ...
        [TestMethod]
        [Ignore, TestCategory(Categories.InternetExplorer), TestCategory(Categories.Windows)]
        public void GetSpellCheckReturnsTrue_When_SpellCheckAttributeIsNotPresent_InternetExplorer()
        {
            var textAreaElement = App.ElementCreateService.CreateById<TextArea>("myTextArea1");
